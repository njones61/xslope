...
CASES = [
    ...
    ('vp039d', 'circle', 'spencer'),
    ('vp049', 'noncirc', 'janbu'),
    ('vp058', 'circle', 'bishop'),
    ('vp059', 'noncirc', 'janbu'),
    ('vp060', 'noncirc', 'spencer'),
    ('vp106a', 'csearch', 'bishop'),
    ('vp106b', 'csearch', 'bishop'),
    ('vp106c', 'csearch', 'bishop'),
    ('vp106d', 'csearch', 'bishop'),
    ('vp106e', 'csearch', 'bishop'),
    ('vp107a', 'circle', 'bishop'),
    ('vp107b', 'circle', 'bishop'),
    ('vp108a', 'circle', 'bishop'),
    ('vp108b', 'circle', 'bishop'),
    ('vp109', 'circle', 'bishop'),
    ...
    ('vp053', 'noncirc', 'spencer'),
    ('vp055', 'csearch', 'spencer'),
    ('vp056', 'csearch', 'spencer'),
    ('vp057', 'circle', 'spencer'),
    ('vp061a', 'csearch', 'spencer'),
    ('vp061b', 'csearch', 'spencer'),
    ('vp062a', 'csearch', 'spencer'),
    ('vp062b', 'csearch', 'spencer'),
    ('vp063', 'ncsearch', 'spencer'),
    ...
    ('vp070b', 'csearch', 'spencer'),
    ('vp071a', 'csearch', 'spencer'),
    ('vp071b', 'csearch', 'spencer'),
    ('vp072a', 'circle', 'spencer'),
    ('vp072b', 'circle', 'spencer'),
    ('vp073', 'csearch', 'spencer'),
    ('vp074', 'csearch', 'spencer'),
    ('vp075', 'csearch', 'spencer'),
    ('vp076a', 'csearch', 'spencer'),
    ('vp076b', 'csearch', 'spencer'),
    ('vp077a', 'csearch', 'spencer'),
    ('vp077b', 'csearch', 'spencer'),
    ('vp078', 'csearch', 'bishop'),
    ('vp079', 'csearch', 'spencer'),
    ('vp080a', 'circle', 'spencer'),
    ('vp080b', 'circle', 'spencer'),
    ('vp081', 'csearch', 'spencer'),
    ('vp082', 'csearch', 'spencer'),
    ('vp083a', 'csearch', 'spencer'),
    ('vp083b', 'csearch', 'spencer'),
    ('vp084a', 'csearch', 'spencer'),
    ('vp084b', 'csearch', 'spencer'),
    ('vp084c', 'csearch', 'spencer'),
    ('vp084d', 'csearch', 'spencer'),
    ...
    ('vp102a', 'csearch', 'spencer'),
    ('vp102b', 'csearch', 'spencer'),
