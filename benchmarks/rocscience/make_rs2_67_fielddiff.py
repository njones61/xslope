...
from build_rs2 import (_RS2_67_DAM, _RS2_67_UP_DAYLIGHT, _RS2_67_DN_DAYLIGHT,
                       _poly_slope_data)
...
def own_flow_90h(target_size=3.0):
    ...
    sd = _poly_slope_data(polygons=[(0, _RS2_67_DAM)], materials=[m],
...
def make_figure():
    ...
    dam = np.array(_RS2_67_DAM + [_RS2_67_DAM[0]])
