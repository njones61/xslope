...
_RS2_FAST = ('rs2_56a rs2_56b rs2_56c1 rs2_56c3 rs2_56c4 '
             ...
             'rs2_64h_split rs2_64l_split rs2_29clay rs2_9').split()
...
GROUPS = {
    ...
    'gw': dict(module='build_groundwater', outattr='OUT',
               ...
               builders=lambda m: [getattr(m, n) for n in
                                   ('gw001 gw002 gw003 gw004 gw005 gw006a gw006b '
                                    'gw006c gw006d gw006e gw007 gw008 gw009a gw009b '
                                    'gw010 gw011 gw012 gw013').split()] + list(m._TRANSIENT),
               slow=False),
    ...
    'ssrm': dict(module='benchmarks.build_ssrm', outattr='OUTDIR',
                 ...
                 slow=False),
    'hassiotis': dict(module='benchmarks.build_hassiotis', outattr='OUT',
                      corpus='docs/lem/files',
                      builders=lambda m: list(m.BUILDERS),
                      slow=False),
    'torggler': dict(module='benchmarks.build_torggler', outattr='OUT',
                     corpus='docs/fem/files',
                     builders=lambda m: list(m.BUILDERS),
                     slow=False),
