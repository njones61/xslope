...
<!-- test: file=files/xslope_prob_submerged_KEY.xlsx, type=reliability_mc, method=spencer, search=true, n_samples=10000, converge_pf=0.01, expected_beta=0.968, tolerance=0.02, expected_pf=0.169, pf_tol=0.02 -->
