...
<!-- test: file=files/xslope_prob_submerged_KEY.xlsx, type=reliability_mc, method=spencer, search=true, n_samples=2000, expected_beta=0.981, tolerance=0.02, expected_pf=0.165, pf_tol=0.02 -->
