...
Two settings further down the dialog are the ones a jointed model needs, and both
are covered in [FEM-3](fem03_block_wall_joints.md#running-the-wall-alone).
