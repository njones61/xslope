...
| 4 | [Water in the Slope](lem04_water_in_the_slope.md) | A three-layer slope with a piezometric line, measured on one pinned deep circle — the same surface dry and wet, pore pressure on every slice base, the γ/γ_sat unit-weight split, r<sub>u</sub>, and a fixed-surface sweep on a saturated unit weight | Limit equilibrium | three materials, piezometric line, effective stress, single surface, saturated unit weight, sensitivity sweep | 5–20 min |
| 5 | [A Weak Layer, Non-Circular](lem05_weak_layer_noncircular.md) | A sand slope over a 2 ft seam of soft clay, with the failure surface entered as a table of vertices instead of a circle — the methods a polyline rules out, where in the seam the track belongs, and how to recognise a surface whose factor of safety means nothing | Limit equilibrium | four materials, piezometric line, non-circular surface, Movement options, weak-zone generator | 5–20 min |
