...
| 10 | [Finding the Global Minimum](lem10_global_minimum.md) | A cohesionless embankment on soft clay, searched twice from two starting circles — a surficial sliver on the sand face and the deep foundation failure — then found without seeding using grid search and a minimum slip depth | Limit equilibrium | two materials, profile lines, starting circles, circular search, grid seeding, minimum slip depth | 5–15 min |
