...
| 5 | [A Weak Layer, Non-Circular](lem05_weak_layer_noncircular.md) | A sand slope over a 2 ft seam of soft clay, with the failure surface entered as a table of vertices instead of a circle — the methods a polyline rules out, where in the seam the track belongs, and how to recognise a surface whose factor of safety means nothing | Limit equilibrium | four materials, piezometric line, non-circular surface, Movement options, weak-zone generator | 15–20 min |
