...
| 4 | [Water in the Slope](lem04_water_in_the_slope.md) | A three-layer slope on a soft foundation clay, searched for its critical circle and then measured on it — the same surface with the pore pressures on and off, u on every slice base, the γ/γ_sat unit-weight split, r<sub>u</sub>, and a held-surface sweep on a saturated unit weight | Limit equilibrium | three materials, piezometric line, effective stress, saturated unit weight, circular search, sensitivity sweep | 5–20 min |
