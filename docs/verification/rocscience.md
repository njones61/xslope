...
| Method | XSLOPE | Slide (GLE, same circle) | D&W |
|---|---|---|---|
| Bishop | 1.567 | 1.575 (GLE — cross-method) | 1.51 (+3.8%) |
| Spencer | 1.567 | 1.575 (GLE — cross-method) | — |
...
procedure and its R-envelope. The recorded values are Slide 1.347 and USACE 1.35.
