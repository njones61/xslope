...
| 105 | Anisotropic surface, multi-modal optimization (MMO) | *blocked* | Capability gate: needs an orientation-dependent (dip-relative) strength model ([scope](scope.md#strength)), the same gap that blocks [GeoStudio §2.47](geostudio.md). |
