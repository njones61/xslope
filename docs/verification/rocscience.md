...
| [42](#vp42) | Dam, (3) materials, water table, ponded water, tension crack | **built** | [vp042.xlsx](../files/rocscience/vp042.xlsx). Baker & Leshchinsky (2001) safety-map clay-core dam — the corpus's statics-convention finding (rigorous total-weight + u + reservoir-load statics vs the published buoyant-weight shortcut; see section). Also [SLOPE/W §2.25](geostudio.md) — same problem in the GeoStudio corpus. |
