...
as well leaves the unrotated-head factor of safety at 1.587 and moves the free-head one by a single
bisection step, because the tip sits on the model's own base.
