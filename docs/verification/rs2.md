...
| [23](#rs2-23) | Underwater slope with linearly varying cohesion | *no lock possible* | RS2's published SSRM (1.12) depends on a "can't fail" elastic region; this slope's anchor remains the LEM lock (VP29, Spencer 1.145 on Duncan's surface). |
...
| [27](#rs2-27) | Homogeneous slope, pore pressure by r<sub>u</sub> | *blocked* | The FEM has no r<sub>u</sub> option (task, with RS2 #14); RS2's own text cites Slide2 VP36 (Li & Lumb), not VP21. |
...
| **Part II (35–58)** | | | |
| 35 | Submerged slope | *planned* | Slide2 VP64 family. |
...
| 38 | Cohesionless embankment on saturated clay foundation | *planned* | Slide2 VP73/VP74 family. |
| 39, 41, 43 | Earth embankment, infinite-slope mechanism (I–III) | *planned* | Slide2 VP69 family. |
...
| [48–54](#rs2-48) | Multi-tiered geotextile walls (Leshchinsky & Han 2004) | *blocked* | The FEM reinforcement tensile-capacity cap is not enforced in SSRM. Extraction and published tables are complete for all seven; the series unlocks together when the cap is fixed. |
...
Slide2 counterpart: **VP1** (ACADS 1a). SSRM 0.986 vs RS2 SSRM 0.99, Slide Bishop 0.987,
ACADS referee 1.00. FS reads 0.967 at half the element size — SSRM values are quoted at the
tagged mesh.

Input file: [xslope_acads_simple.xlsx](../lem/files/xslope_acads_simple.xlsx)
...
Slide2 counterpart: **VP3**. SSRM 1.375 vs RS2 1.36, Slide Spencer 1.375, referee 1.39.

Input file: [vp003.xlsx](../files/rocscience/vp003.xlsx)
...
Slide2 counterpart: **VP4**. SSRM 0.948 vs RS2 0.97, Slide Spencer 0.991, referee 1.00.
...
Input file: [vp004.xlsx](../files/rocscience/vp004.xlsx)
...
Slide2 counterpart: **VP5**. SSRM 1.909 vs RS2 1.88, Slide 1.948, referee 1.95.

Input file: [vp005.xlsx](../files/rocscience/vp005.xlsx)
...
Slide2 counterpart: **VP7**. SSRM 1.286 (mesh-stable: 1.280 at 1.2 m) vs RS2 1.26, Slide
Spencer 1.258, referee 1.24–1.27. This problem is Slide VP7.

Input file: [xslope_acads_weak_layer.xlsx](../lem/files/xslope_acads_weak_layer.xlsx)
...
Slide2 counterpart: **VP9**. Built with a caveat: SSRM 0.81, mesh-stable, vs ACADS survey
mean 0.808 and referee 0.78 — but +18% above RS2's SSRM 0.69 and Slide2's MC-optimized LEM
0.68–0.71 (XSLOPE's own LEM locks 0.724). The published values themselves span 0.68–0.81
on this thin-weak-seam problem; under the same investigation as [#16](#rs2-16).

Input file: [vp009.xlsx](../files/rocscience/vp009.xlsx)
...
Slide2 counterpart: **VP10**. SSRM 1.483 vs RS2 SSRM 1.48 (+0.2%), on the FE-seepage model
XSLOPE built for Slide2 VP10 (the grid is a stand-in for the flow solution; sidecars are
tri6 so the SSRM plasticity is not volumetrically locked). Slide2 LEM 1.498–1.501, Giam
1.53.

Input file: [vp010.xlsx](../files/rocscience/vp010.xlsx)
...
Slide2 counterpart: **VP11**. *No lock possible*: the grid encodes measured
construction-induced pressures (see the Slide2 corpus VP11 row); RS2 SSRM 0.96 vs Pilot
1.04 recorded.

### RS2-9: Cubzac-les-Ponts test embankment {#rs2-9}

Slide2 counterpart: **VP13**. *No lock possible*: measured pore-pressure grid plus a
"can't fail" elastic face layer suppressing the true face failure (FS 1.11 per RS2's own
text); RS2 SSRM 1.31 vs Pilot 1.24 recorded.

### RS2-10: Simple slope II (Arai & Tagyo ex. 1) {#rs2-10}

Slide2 counterpart: **VP14** (Arai & Tagyo 1). SSRM 1.43 vs RS2 SSRM 1.40 (+2%),
mesh-converged (1.428→1.434 over a 2.9× size change); LEM locks Bishop 1.404 / Spencer
1.401 vs Slide2 1.409 / 1.406.

Input file: [xslope_arai_tagyo.xlsx](../lem/files/xslope_arai_tagyo.xlsx)
...
Slide2 counterpart: **VP15**. SSRM 0.41 vs RS2 SSRM 0.39 and Greco/Kim pattern-search
0.39–0.43; LEM locks 0.419–0.422.

Input file: [vp015.xlsx](../files/rocscience/vp015.xlsx)
...
Slide2 counterpart: **VP16**. SSRM 1.12 vs RS2 SSRM 1.09 (+2.3%); LEM locks Bishop 1.112 /
Spencer 1.113. The FEM piezo pore pressure uses the vertical-distance convention,
consistent with the LEM slicer and the published analyses.

Input file: [vp016.xlsx](../files/rocscience/vp016.xlsx)
...
Slide2 counterpart: **VP17**. SSRM 1.38 vs RS2 SSRM 1.33 and Greco Spencer 1.33; LEM locks
Bishop 1.342 / Spencer 1.340 vs Y&U 1.348 / 1.339.

Input file: [vp017.xlsx](../files/rocscience/vp017.xlsx)
...
Input file: [vp018.xlsx](../files/rocscience/vp018.xlsx)
...
Slide2 counterpart: **VP19**. SSRM 1.39 vs RS2 SSRM 1.39, Slide2 Spencer 1.398, Greco
1.40–1.42; mesh-converged (1.386→1.377 over a 1.7× size change).

Input file: [vp019.xlsx](../files/rocscience/vp019.xlsx)
...
Slide2 counterpart: **VP20**. SSRM 0.972 (0.983 at 4.0 m, 0.961 at 2.2 m) vs RS2 SSRM 1.02,
Slide2 Spencer 1.093 circular / 1.007 noncircular, Greco 0.973–1.1; LEM locks 1.086–1.091
on the same file.
...
Input file: [vp020.xlsx](../files/rocscience/vp020.xlsx)
...
Slide2 counterpart: **VP21**. Built for the dry and r<sub>u</sub> cases: dry SSRM 2.02 vs
RS2 SSRM 2.0, Slide2 M-P 2.075, F&K 2.076 (on [vp021a.xlsx](../files/rocscience/vp021a.xlsx));
r<sub>u</sub> = 0.25 SSRM 1.704, mesh-stable (1.696 at 2.0 m), against F&K's LEM 1.761–1.766
and Slide2's 1.760–1.763 (on [vp021b.xlsx](../files/rocscience/vp021b.xlsx)) — the usual few
percent of SSRM-under-LEM. This table does not record RS2's own SSRM for the r<sub>u</sub>
sub-case, so that cross-check is still open. The water-table case awaits the VP21 case-3
input file.
...
Slide2 counterpart: **VP22**. Built for the dry and r<sub>u</sub> cases: dry SSRM 1.34 vs
RS2 SSRM 1.34, Slide2 Bishop 1.382 (on [vp022a.xlsx](../files/rocscience/vp022a.xlsx));
r<sub>u</sub> = 0.25 SSRM 1.054 against Slide2 1.124 and F&K 1.124 (on
...
Slide2 counterpart: **VP24** (this problem is Slide2 VP24). Built with a caveat: SSRM 1.51
at the tagged mesh (1.48 at 0.6 m) vs RS2 SSRM 1.41, Slide2 LEM 1.439, Low 1.44 — the SSRM
values straddle the LEM from opposite sides on this φ = 0 slope, and the XSLOPE factor
drifts −2% with refinement; quoted at the tagged mesh per the page convention.

Input file: [vp024.xlsx](../files/rocscience/vp024.xlsx)
...
Slide2 counterpart: **VP25**. SSRM 1.00 vs Prandtl theory 1.0 and RS2 SSRM 1.0 (mesh pair
1.011→1.003); Slide2 Spencer reads 1.051 on the specified surface.

Input file: [vp025.xlsx](../files/rocscience/vp025.xlsx)
...
Slide2 counterpart: **VP26**. SSRM 1.011 (1.020 at 1.2 m), converging on theory 1.0; RS2
SSRM 1.01; Slide2 Spencer 0.941 on the specified surface. The input file was extracted for
this problem.

Input file: [vp026.xlsx](../files/rocscience/vp026.xlsx)
...
Slide2 counterpart: **VP27**. Built on an SSRM variant: SSRM 1.558 (1.536 at 1.8 m,
converging) vs RS2 SSRM **1.52** — +2.5% at the tagged mesh, +1.1% at the finer one.
...
Slide2 counterpart: **VP29**. *No lock possible*: RS2's published SSRM (1.12) depends on a
"can't fail" elastic region whose boundary its text and figure draw differently; stand-ins
for the two readings give 0.87 and 0.92, and without the patch the true SSRM minimum is the
shallow skin above el. −20 (FS 0.21) that the artifice suppresses. The comparison would test
where the patch is drawn, not the mechanics — this slope's anchor remains the LEM lock
(VP29, Spencer 1.145 on Duncan's surface).

### RS2-24: Layered slope with geosynthetic reinforcement {#rs2-24}

Slide2 counterpart: **VP32**. SSRM 1.196 (H=7 case; mesh-stable 1.202 at 2.2 m) and 0.991
(H=8.75) vs RS2 SSRM 1.15 / 0.95 (+4%, within the corpus SSRM scatter; geotextile as an FEM
truss with EA = 2×10³ kN/m stated as convention). RS2's fully labeled figures also supplied
the geometry that unlocked Slide2's VP32 — LEM locks on the three printed circles live
there.
...
Slide2 counterpart: **VP33**. Built with a caveat: SSRM 1.20 (mesh-converged) vs RS2 SSRM
1.29, Slide2 Bishop 1.305, El-Ramly 1.31 — the weak presheared clay-shale rewards
less-constrained searches (XSLOPE's own LEM: 1.299 on Slide's circle, 1.253 free composite
search, SSRM 1.20); locked at the tagged mesh.

Input file: [vp033.xlsx](../files/rocscience/vp033.xlsx)
...
Slide2 counterpart: **VP34**. SSRM 2.28 vs RS2 SSRM 2.29 (−0.4%); Slide2 GLE 2.333 / Spencer
2.383, W&H 2.36, XSLOPE LEM M-P 2.384. Polygon zones with the chimney drain.

Input file: [vp034.xlsx](../files/rocscience/vp034.xlsx)
...
Slide2 counterpart: **VP36**. *Blocked*: the FEM has no r<sub>u</sub> option (task, with RS2
[#14](#rs2-14)); RS2's own text cites Slide2 VP36 (Li & Lumb), not VP21.

### RS2-29: Geosynthetic-reinforced embankment on soft soil (Tandjiria 2002) {#rs2-29}

Slide2 counterpart: **VP39**. The manual's §29/§30 headings are swapped. Built for the sand
case: SSRM 1.253 vs RS2 SSRM 1.25, Spencer 1.209, Tandjiria 1.219. The clay case (RS2 SSRM
0.99) is not locked: its water-filled tension crack has no FEM representation (XSLOPE reads
1.05 without it).

Input file: [vp039c.xlsx](../files/rocscience/vp039c.xlsx)
...
Slide2 counterpart: **VP40**. Swapped heading (see [#29](#rs2-29)). SSRM 0.910 vs RS2 SRF
0.91 (exact); Slide2 Janbu 0.944, Perry 0.98. The FEM linearizes the reduced envelope at the
current stress per iteration.

Input file: [vp040.xlsx](../files/rocscience/vp040.xlsx)
...
Slide2 counterpart: **VP44**. Built, all three halves: M-C SSRM 1.546 / 0.966 vs RS2 1.53 /
0.98; power-curve SSRM 0.934, squarely on Slide2's own published band (Janbu 0.92 / Spencer
0.96, Baker ~0.97) — RS2's 1.11 sits 15% above Slide2's LEM on the same problem and is the
outlier.
...
Slide2 counterpart: **VP45**. Built, both halves: M-C SSRM 2.852 vs RS2 2.83 (+0.8%);
power-curve SSRM 2.732 vs RS2 2.74 (−0.3%), Slide2 Spencer 2.662.
...
Slide2 counterpart: **VP56**. Swapped heading. Built with a caveat: SSRM 1.247 vs RS2 SSRM
1.28 and an eight-program LEM table spanning 1.03–1.32; the model's dry tension crack has no
FEM representation, worth ~2–3% here.

Input file: [vp056.xlsx](../files/rocscience/vp056.xlsx)
...
Slide2 counterpart: **VP61**. Built, both halves: M-C SSRM 1.369 vs RS2 1.38; power-curve
SSRM 1.502 vs RS2 1.47 / Slide2 Spencer 1.47 / Baker 1.48 (+2.1%).
...
Slide2 counterpart: **VP71** (= Slide2 VP71, not VP70). Built, both cases: SSRM 1.118 on the
FE-seepage model and 1.118 on the piezo approximation vs RS2 SSRM 1.12 / 1.12; referee
1.138/1.141; XSLOPE LEM locks 1.132. The seep case runs on tri6 sidecars.
...
Slide2 counterpart: **VP72**. Reported, no lock: RS2's SSRM is the artesian downstream-toe
slide, quoted as 0.95 in its table and 1.1 in its own convergence graph; XSLOPE's SSRM finds
the deep mechanism at 1.31 (LEM on the tangent circle 1.339, Slide2 1.15/1.16, referee
1.11). Reproducing the toe mechanism needs toe-refined meshing — noted with the artesian-toe
discussion in the Slide2 VP72 section.

### RS2-40: Dam with impermeable foundation (D&W Fig 7.24) {#rs2-40}

Slide2 counterpart: **VP77**. Built for the piezo case: SSRM 1.491 vs RS2 SSRM 1.53; the
FE-seepage case is blocked — tri6 seepage does not converge on the high-contrast thick core
(the documented tri3/tri6 trade).

Input file: [vp077b.xlsx](../files/rocscience/vp077b.xlsx)
...
Slide2 counterpart: **VP75**. SSRM 1.249 vs RS2 SSRM 1.26 (−0.9%); Slide2 noncircular LEM
1.11–1.16, referee 1.17.

Input file: [vp075.xlsx](../files/rocscience/vp075.xlsx)
...
Slide2 counterpart: **VP82** (= Slide2 VP82, not VP76 — §39's body carries VP76). SSRM 1.511
vs RS2 SSRM 1.51 (+0.1%); Slide2 LEM 1.532/1.541, referee 1.528–1.542.

Input file: [vp082.xlsx](../files/rocscience/vp082.xlsx)
...
Slide2 counterpart: **VP83**. Built with a caveat: SSRM 1.41 / 1.37 vs RS2 SSRM 1.32 / 1.32
(D&W referee 1.28–1.33): XSLOPE's SSRM reads high on φ=0 foundations (the [RS2-19](#rs2-19)
family, under investigation); locked as regression values at the tagged mesh.
...
Slide2 counterpart: **VP84**. SSRM 0.80 / 0.95 / 1.08 / 1.19 vs RS2 SSRM 0.78 / 0.93 / 1.05 /
1.15 (+2–3%, the φ=0 pattern); D&W 0.75 / 0.90 / 1.03 / 1.13.
...
Slide2 counterpart: **VP78**. Built for the 30-ft case: SSRM 1.08 vs RS2 SSRM 1.03; D&W
referee 1.124–1.135. The 46.5- and 60-ft variants (RS2 1.02 / 1.02) need deepened-base
builds and are deferred.

Input file: [vp078.xlsx](../files/rocscience/vp078.xlsx)
...
Slide2 counterparts: **VP87–VP93** (one-for-one, verified). *Blocked*: the FEM reinforcement
tensile-capacity cap is not enforced in SSRM (proven Ta-insensitive on the baseline wall:
unreinforced 0.41, any Ta 1.72 vs published ≈1.0). Extraction and published tables are
complete for all seven; the series unlocks together when the cap is fixed. Problem 55 (five
1.8-m tiers, Slide2 VP94) belongs to this family and is blocked with the series.

### RS2-56: Homogeneous slope vs Z-Soil, PLAXIS, GEO FEM (Pruska 2003, H = 7 m, 5 cases) {#rs2-56}

New corpus files (no Slide2 counterpart). Built: all five within ±3.3% of RS2's M-C and
inside the four-program band; locks bracket the family (0.667 / 2.131). Full case-by-case
tables are in [the Pruska cross-bearing section](#pruska).
...
New corpus files. Built: all six within ±3.6% of RS2's M-C; locks 0.449 / 1.411. Full tables
in [the Pruska cross-bearing section](#pruska).
...
New corpus files. Built (5 of 6): four within ±3.6%; case 5 (c=5, φ=30) reads 0.667 vs a
tight published 0.72–0.75 cluster and is reported unlocked pending explanation; locks 0.342
/ 1.057. Full tables in [the Pruska cross-bearing section](#pruska).
