...
| [6](#rs2-6) | 🟢 | Slope with load and pore pressure by water table (ACADS 4) | SSRM 0.792 vs ACADS referee 0.78 (+1.5%) | **built** (caveat) — +14.8% above RS2's own SSRM 0.69, and above Slide2's MC-optimized LEM. |
...
| [14](#rs2-14) | 🟡 | Simple slope, pore pressure by r<sub>u</sub> | SSRM 0.934 vs RS2 SSRM 0.98 (−4.7%) | **built** (caveat) — the factor never becomes mesh-independent; the tag pins 2.0 m as a regression lock. |
...
| [50](#rs2-50) | 🟢 | Geotextile wall, 4.2 m reinforcement variant | SSRM 0.979 vs L&amp;H FDM referee 0.98 (−0.1%) | RS2 SSR 0.93 recorded, not scored — see [RS2-48](#rs2-48). The variant locks at the paper's reinforcement stiffness, where at the vendor's it did not. |
...
| [52](#rs2-52) | <span class="nodata">⊘</span> | Geotextile wall, weak-foundation variant | | *reported, no lock* — one trial of the bracket reaches the sweep budget without a verdict. Both published factors are below the rest of the family and XSLOPE's is further below still, and the two do not describe the same mechanism — see the section. |
| [53](#rs2-53) | <span class="nodata">⊘</span> | Geotextile wall, water variant | | *reported, no lock* — two trials reach the sweep budget without a verdict on each of the two meshes, and a step of refinement moves the factor by six times the bracket tolerance. |
| [54](#rs2-54) | <span class="nodata">⊘</span> | Geotextile wall, crest-surcharge variant | | *reported, no lock* — a step of refinement moves the factor by twice the bracket tolerance. Built at the paper's T<sub>a</sub> = 11.6 kN/m, the strength the referee's wall carries; the vendor model ships the baseline's 10 kN/m and its SSR is recorded against that wall — see the section. |
...
| [61](#rs2-61) | 🟢 | Local and global minima, homogeneous slope | Case 1: Spencer 1.338 vs Slide2 1.336 (+0.1%) · Case 3: Spencer 1.437 vs Slide2 1.443 (−0.4%) · Case 2: constrained SSRM 1.383 vs RS2 SSRM 1.36 (+1.7%) | **built** (cases 1, 3, 2) — one geometry, four search regions; case 2 uses RS2's own Search-Area polygon. Case 4 blocked. |
| [62](#rs2-62) | 🟡 | Three-layered slope with a soft band | SSRM 0.769 vs RS2 SSR 0.81 (−5.1%) | **built** (Analysis III) — the decisive input is the vendor per-material tensile strength reduced with the SRF; without it the FE equilibrates at F ≥ 1.3. |
...
| [66](#rs2-66) | 🟢 | Embankment basal stability | Face skin, worst leg (h₁ = 4, 6 and 8 m): SSRM 1.031 vs closed form 1.050 (−1.8%) · thinnest and thickest bands (h₁ = 2 and 10 m): SSRM 1.044 vs 1.050 (−0.6%) | **built** — two mechanisms, both locked across all five soft-layer thicknesses; the deep run uses `min_slip_depth` = 4 m, and every file meshes its soft band at 1.05 m. The dot is the face skin's, against a closed form that does not depend on the flow rule, and the worst of the five legs sets it: none is wider, and the two extreme thicknesses are the narrowest. The deep family (1.169 at h₁ = 2 and 4 m, 1.044–1.094 at 6, 8 and 10 m) is recorded beside RS2's SSR column rather than scored against it: every published strength-reduction solution of this problem runs associated flow, ψ = φ, where XSLOPE runs ψ = 0. |
...
| [4](#rs2-3) | 🟢 | Slope, 3 materials, seismic (ACADS 1d) | SSRM 0.948 vs RS2 SSRM 0.97 (−2.3%) | Piggyback on [RS2-3](#rs2-3). Part IV publishes RS2 SSRM 0.95; ref 1.00. |
...
| [7](#rs2-5) | 🟢 | Slope, 2 materials, weak layer (ACADS 3a) | SSRM 1.286 vs RS2 SSRM 1.26 (+2.1%) | Piggyback on [RS2-5](#rs2-5). Part IV publishes RS2 SSRM 1.24; ref 1.24–1.27. |
| [9](#rs2-6) | 🟢 | Weak layer, water table, load (ACADS 4) | SSRM 0.792 vs ACADS referee 0.78 (+1.5%) | Piggyback on [RS2-6](#rs2-6). Part IV publishes RS2 SSRM 0.76. |
...
| [16](#rs2-12) | 🟢 | Slope, homogeneous, water table (Arai & Tagyo 3) | SSRM 1.115 vs RS2 SSRM 1.09 (+2.3%) | Piggyback on [RS2-12](#rs2-12). |
...
| [69](#p4-vp69) | 🟢 | Embankment, 2 materials, steady seepage (USACE 2003 F-6) | SSR Search Area: SSRM 1.944 vs RS2 SSRM 1.94 (+0.2%) | **built** (caveat) — RS2's published factor is constrained by the 38-vertex Search Area in `#069.fez`, which the tag carries verbatim. Both zones are c = 0, so the factor drifts with refinement (2.031 / 1.981 / 1.944 / 1.931 at 8 / 6.5 / 5 / 4 ft); the tag pins the 5 ft mesh. Unconstrained, 1.508. USACE 2.01, Slide2 Spencer 2.026. |
...
| [74](#rs2-38) | 🟢 | Cohesionless embankment on clay (D&W Fig 7.12) | SSRM 1.201 vs RS2 SSRM 1.17 (+2.6%) | Piggyback on [RS2-38](#rs2-38); Spencer 1.20. |
...
| [78](#rs2-47) | 🟢 | Purely cohesive slope, thickness variants (D&W Fig 14.3) | 30 ft: SSRM 1.061 vs RS2 SSRM 1.06 (+0.1%) · 46.5 ft: SSRM 1.061 vs RS2 SSRM 1.06 (+0.1%) · 60 ft: SSRM 1.045 vs RS2 SSRM 1.07 (−2.3%) | Piggyback on [RS2-47](#rs2-47), all three thicknesses on the case-(a) models; D&W 1.12–1.14. |
...
| [81](#rs2-39) | 🟢 | Earth embankment, infinite-slope failure (D&W Fig 14.7) | SSRM 1.228 vs RS2 SSRM 1.23 (−0.2%) | Piggyback on [RS2-43](#rs2-39), under the vendor model's own SSR Exclusion Area. Part IV case 2 publishes 1.15; ref 1.21 / 1.15. |
...
<!-- test: file=files/rocscience/vp004.xlsx, type=fem_ssrm, expected_fs=0.948, element_type=tri6, target_size=0.9, tolerance=0.01, f_min=0.7, f_max=1.3, max_iter=16000, tension_srf=false, k0=1, benchmark=RS2-3 -->
...
published 1.26; XSLOPE's wet reconstruction reproduces that value (1.286), so the file is
kept as the faithful build of the published problem.

<!-- test: file=../lem/files/xslope_acads_weak_layer.xlsx, type=fem_ssrm, expected_fs=1.286, element_type=tri6, target_size=2.0, tolerance=0.01, f_min=0.9, f_max=1.6, max_iter=16000, tension_srf=false, k0=1, benchmark=RS2-5 -->
...
<!-- test: file=files/rocscience/vp009.xlsx, type=fem_ssrm, expected_fs=0.792, element_type=tri6, target_size=1.3, tolerance=0.02, f_min=0.3, f_max=1.3, max_iter=16000, tension_srf=false, k0=1, benchmark=RS2-6 -->
...
<!-- test: file=files/rocscience/rs2_9.xlsx, type=fem_ssrm, expected_fs=1.309, element_type=tri6, target_size=1.0, tolerance=0.02, f_min=0.8, f_max=2.2, max_iter=16000, tension_srf=false, k0=1, elastic_materials=Embankment (elastic face skin), benchmark=RS2-9 -->
...
<!-- test: file=files/rocscience/vp016.xlsx, type=fem_ssrm, expected_fs=1.115, element_type=tri6, target_size=1.3, tolerance=0.02, f_min=0.9, f_max=1.45, max_iter=16000, tension_srf=false, k0=1, benchmark=RS2-12 -->
...
|---|---|---|---|---|---|
| SSRM (regression lock at the 2.0 m mesh) | 0.934 | 0.98 (−4.7%) | 1.01 | 1.02 | Spencer 1.033 |

The SSRM factor on *this* model does not become mesh-independent: 0.972 → 0.934 → 0.878 → 0.859
as the target size goes 2.8 → 2.0 → 1.4 → 1.0 m, falling at every rung rather than reaching a
plateau. The tag pins 2.0 m as a
...
<!-- test: file=files/rocscience/vp018.xlsx, type=fem_ssrm, expected_fs=0.878, element_type=tri6, target_size=1.4, tolerance=0.02, f_min=0.7, f_max=1.3, max_iter=16000, tension_srf=false, k0=1, benchmark=RS2-14-m1.4 -->
...
<!-- test: file=files/rocscience/vp018.xlsx, type=fem_ssrm, expected_fs=0.934, element_type=tri6, target_size=2.0, tolerance=0.02, f_min=0.7, f_max=1.3, max_iter=16000, tension_srf=false, k0=1, benchmark=RS2-14 -->
...
same-method vendor pairing at −4.1%. Nearly mesh-invariant: 0.997 at 4.0 m, easing to 0.978 at
3.0 and 2.2 m. The LEM locks
...
<!-- test: file=files/rocscience/vp020.xlsx, type=fem_ssrm, expected_fs=0.997, element_type=tri6, target_size=4.0, tolerance=0.02, f_min=0.8, f_max=1.4, max_iter=16000, tension_srf=false, k0=1, benchmark=RS2-16-m4.0 -->
<!-- test: file=files/rocscience/vp020.xlsx, type=fem_ssrm, expected_fs=0.978, element_type=tri6, target_size=2.2, tolerance=0.02, f_min=0.8, f_max=1.4, max_iter=16000, tension_srf=false, k0=1, benchmark=RS2-16-m2.2 -->
...
<!-- test: file=files/rocscience/vp022a.xlsx, type=fem_ssrm, expected_fs=1.334, element_type=tri6, target_size=1.5, tolerance=0.02, f_min=1.0, f_max=1.7, max_iter=16000, tension_srf=false, k0=1, benchmark=RS2-18 -->
<!-- test: file=files/rocscience/vp022b.xlsx, type=fem_ssrm, expected_fs=1.042, element_type=tri6, target_size=1.5, tolerance=0.02, f_min=0.8, f_max=1.8, max_iter=16000, tension_srf=false, k0=1, benchmark=RS2-18b -->
...
|---|---|---|---|---|
| SSRM | 1.488 at the tagged mesh | Low 1.44 (+3.3%) | 1.41 (+5.5%) | 1.439 |

*Low's own factor is the source author's and governs; RS2's SSRM is the same-method vendor
pairing at +5.5%, and the two SSRM values straddle the LEM.*
...
<!-- test: file=files/rocscience/vp024.xlsx, type=fem_ssrm, expected_fs=1.488, element_type=tri6, target_size=1.0, tolerance=0.02, f_min=1.1, f_max=1.8, max_iter=16000, tension_srf=false, k0=1, benchmark=RS2-19 -->
...
<!-- test: file=files/rocscience/vp027_fem.xlsx, type=fem_ssrm, expected_fs=1.523, element_type=tri6, target_size=2.5, tolerance=0.02, f_min=1.2, f_max=1.9, max_iter=16000, tension_srf=false, k0=1, benchmark=RS2-22 -->
...
elements against the tagged mesh's 1 457 and the strength reduction reads **1.188**, further below
...
<!-- test: file=files/rocscience/vp033.xlsx, type=fem_ssrm, expected_fs=1.188, element_type=tri6, target_size=2.5, tolerance=0.02, f_min=0.9, f_max=1.8, max_iter=16000, k0=1, benchmark=RS2-25-m2.5 -->
...
<!-- test: file=files/rocscience/vp074.xlsx, type=fem_ssrm, expected_fs=1.201, element_type=tri6, target_size=7.0, tolerance=0.02, f_min=0.9, f_max=1.6, max_iter=16000, tension_srf=false, k0=1, benchmark=RS2-38 -->
...
the rest), the SSRM reads **1.228**, −0.2% on that model's own published value: the `_deep` file is
...
<!-- test: file=files/rocscience/vp081.xlsx, type=fem_ssrm, expected_fs=1.228, element_type=tri6, target_size=1.5, tolerance=0.02, f_min=0.9, f_max=1.5, max_iter=16000, tension_srf=false, ssr_zone=128;34;128;15;128;0;0;0;0;15;35;15;39.1558;15;71.1539;29.9985;73;34;128;34, k0=1, benchmark=RS2-43 -->
...
Slide2-import set runs #076 straight to #078 — as `#040_01` for the finite-element seepage case and
...
runs the route the case names: mesh the dam at the tagged 12.4 ft in tri6, solve the model's own
...
the other φ = 0 foundation problem, reads +5.5% against RS2's own SSRM and keeps its caveat.
...
<!-- test: file=files/rocscience/vp083b.xlsx, type=fem_ssrm, expected_fs=1.330, element_type=tri6, target_size=4.0, tolerance=0.02, f_min=0.9, f_max=1.9, max_iter=16000, tension_srf=false, k0=1, benchmark=RS2-45b -->
...
<!-- test: file=files/rocscience/vp084a.xlsx, type=fem_ssrm, expected_fs=0.773, element_type=tri6, target_size=4.0, tolerance=0.02, f_min=0.4, f_max=1.3, max_iter=16000, tension_srf=false, k0=1, benchmark=RS2-46a -->
...
<!-- test: file=files/rocscience/vp084c.xlsx, type=fem_ssrm, expected_fs=1.043, element_type=tri6, target_size=4.0, tolerance=0.02, f_min=0.6, f_max=1.5, max_iter=16000, tension_srf=false, k0=1, benchmark=RS2-46c -->
...
XSLOPE stays within 2.3% of RS2 at all three thicknesses, and on the 30-ft case sits *between*
...
<!-- test: file=files/rocscience/vp078b.xlsx, type=fem_ssrm, expected_fs=1.061, element_type=tri6, target_size=4.0, tolerance=0.02, f_min=0.6, f_max=1.6, max_iter=16000, tension_srf=false, k0=1, benchmark=RS2-47b -->
...
detail section on the LEM page). Of the eight strength-reduction rows, four are locked at the
family's mesh and four are reported without locks because a step of refinement moves them.
...
RS2's numbers are from Part 2 of its verification manual, problems 48–55, which import this Slide2
model.
...
#### The facing, and which published factor the row is scored against

RS2 does not mesh this wall as one body: its `#048` model splits the solid mesh along the
geotextile layers, joins the halves with frictional slip joints, and runs tension-only beam
elements along the split, so the load path between the reinforced fill and its sheets passes
through sliding interfaces. XSLOPE builds it the same way — each sheet is a reinforcement line
with `Joint = Yes`, on the vendor's interface (Adhesion 0, Delta 28.35°, k<sub>n</sub> =
k<sub>s</sub> = 100 000), running from the back face of its facing column as the vendor places it,
with its front end tied to the column at the sheet's own capacity and its back end free to pull
out.

Where the two models differ is the **facing**. The vendor's facing is the paper's 0.3 × 3 m
Mohr-Coulomb column at c = 2.5 kPa, and Leshchinsky & Han state what that value is for: it "was
used for blocks to prevent possible local failure of the block facing" (p. 4). A 0.3 m column of
c = 2.5, φ = 34 material cannot carry its own weight in this formulation — its unconfined strength
is about 9 kPa against roughly 46 kPa of vertical stress at the base of a 3 m tier — and RS2's own
maximum-shear-strain figure for `#048` shades those columns yielding. So the column is a numerical
crutch standing in for a physical statement: the facing is concrete blocks that do not fail.

XSLOPE makes that statement directly. The blocks are `elastic` and excluded from the strength
reduction, and the facing is built the way the paper describes it — a **dry stack**: a joint line
on each column's back face, one under its base, and a course joint across the column at every
sheet elevation, all on the blocks' own friction (Adhesion 0, δ = 34°, k<sub>n</sub> =
k<sub>s</sub> = 100 000, reduced with the soil). Neither the paper nor the vendor `.fez` states a
block-on-block interface strength, so the blocks' own φ is used. The columns then slide, part and
rock on their courses instead of standing as one body held up by a cohesion nobody measured.

Neither published model's facing is this one. RS2's is a single Mohr-Coulomb body at c = 2.5 kPa;
Leshchinsky & Han's FLAC facing carries the same 2.5 kPa but articulates it, with Mohr-Coulomb
interfaces between the stacked blocks. So the referee's is the nearer of the two — it is the dry
stack, and only the block material differs — and it is the pairing each row's dot comes from. RS2's
factor is recorded beside every row and scores none of them: against a facing meshed as one body
the comparison is a physical one rather than a like-for-like one.

One vendor value is transcribed as stated rather than as the paper's rule would give it: `#049`
keeps δ = 28.35° on its sheets — the angle whose tangent is 0.8 tan 34° — although that variant's
fill is φ = 25°, where the paper's rule would give about 20.5°. The vendor's number is what the file carries.
...
which keep the sheets 0.25 m inside the facing columns because that is where the eight locked
Slide2 circles were measured. Geotextile modeled as an FEM truss at Leshchinsky & Han's own
reinforcement stiffness, J = EA = 1000 kN/m, which is what their FLAC referee ran and what scores
these rows. The vendor `.fez` states EA as 1000 x the sheet's LENGTH instead — 6300 kN/m on the
6.3 m sheets, 4200 on RS2-50's 4.2 m ones — an axial stiffness that grows with the sheet and has
no physical reading, so it is recorded here as a departure rather than carried. The paper's own
sensitivity says little rides on the value: J from 1000 to 100,000 kN/m moved FLAC from 0.99 to
1.03. Every file carries the vendor's tensile caps — T = 0 on the reinforced
granular fill, 10 on the foundation soil, and T = 0 on the c = 0 foundation of the weak-foundation
variant — together with its E = 50,000 kPa and ν = 0.4 on all three materials; the facing carries
no cap, being elastic. The caps are static through the strength reduction, which is the setting
the vendor models carry. Every row runs the isotropic at-rest stress state (k<sub>0</sub> = 1) the
SSRM rows on this page use, and every row states its sweep budget rather than inheriting one. A
joint reaches equilibrium by growing slip, a little per sweep, so a jointed model settles over tens
of thousands of viscoplastic sweeps where a bonded one settles over hundreds; a strength-reduction
trial that runs out of sweeps is recorded as undecided, the bracket reads that as not standing, and
the factor comes out low. These rows run at 250,000, at which every trial on every variant reaches
a verdict — the longest to do so takes about 153,000 — and it costs almost nothing, because a trial
that decides stops. The 0.3 m block columns carry a per-polygon mesh Size of 0.15 m: the
dry stack crosses each column with a joint line every 0.6 m, and at the model's own 1 m target size
gmsh does not return from edge recovery. On the water variant (vp092_fem) the reinforced fill is
...
Two things decide whether a row is locked. The first is a step of refinement — a 2D size of 0.7 m
with a 1D size of 0.5 m and the block columns at 0.105 m: on RS2-48, RS2-50 and RS2-55 that step
moves the answer by one step of the bracket the family runs at, so the two meshes bracket the same
factor and the row is locked at the coarser one, while on RS2-51 and RS2-54 it moves the answer by
two. What moves those two is the **shear localization through the c = 0 reinforced granular
fill**: a cohesionless mass has no intrinsic length scale, so the failing band can collapse onto
the element size and the factor follow the mesh instead of settling. The second is the budget
itself: RS2-49 and RS2-53 each leave two trials of the family's own mesh at 250,000 sweeps without
a verdict, and RS2-52 one, so those three answers are not yet measurements and no row is locked on
them. The two are separate questions, and RS2-49 is the row that shows it: refinement does not move
its factor by so much as one step, and what keeps it reported is the budget alone.

On these wished-in-place walls the geotextile bars are not mobilized to their pullout capacity at
the incipient failure state, so the pullout envelope is not what sets any of these factors. Neither
is the element order: RS2 meshes these walls with `lst_element`, the same 6-node quadratic triangle
XSLOPE uses.

#### The eight rows, one by one

Each is its own problem in the RS2 manual, so each is listed separately in the summary table above
and anchored here. All eight share the model, the mesh and the reinforcement treatment described
above; what follows is only what distinguishes each one and where it ended up.
...
6.3 m long. The strength reduction brackets a factor on the family's mesh and holds it under a
refinement step, and Leshchinsky & Han's FLAC referee — the same dry-stack facing — is what it is
scored against.
...
<!-- test: file=files/rocscience/vp087_fem.xlsx, type=fem_ssrm, expected_fs=1.037, element_type=tri6, target_size=1.0, tolerance=0.02, f_min=0.5, f_max=3.0, max_iter=250000, ssr_exclude=Blocks, tension_srf=false, k0=1, benchmark=RS2-48 -->
...
The reinforced fill's strength is reduced to φ = 25° with T<sub>a</sub> raised to 22 kN/m. The
sheets keep the vendor's δ = 28.35°, which is the one place `#049` departs from the paper's own
rule for it. Two trials of the bracket reach 250,000 sweeps without a verdict, so the factor this
variant brackets is a statement about the budget as much as about the wall, and the row is reported
without a lock.

On this variant the published factors do not agree with each other either: RS2's
...
tensile caps, the sheet layout, the interface constants, the at-rest initial stress, the restraints
— is reproduced in the file, the reinforcement stiffness being the family's one stated
departure.
...
longer cross. The strength reduction brackets a factor on the family's mesh and holds it under a
refinement step.
...
<!-- test: file=files/rocscience/vp089_fem.xlsx, type=fem_ssrm, expected_fs=0.979, element_type=tri6, target_size=1.0, tolerance=0.02, f_min=0.5, f_max=3.0, max_iter=250000, ssr_exclude=Blocks, tension_srf=false, k0=1, benchmark=RS2-50 -->
...
Every trial of both brackets reaches a verdict, and a step of refinement moves the factor by twice
the bracket tolerance, so the variant is reported without a lock.

![RS2-51: two geotextile grades in one wall (vp090_fem, Ta = 11.0 kN/m on the lower seven layers, 7.5 kN/m above) — FEM inputs, mesh, max shear strain and displacement vectors at the critical SRF. The geometry is the baseline's; the two grades differ in tensile capacity, anchorage length and interface shear stiffness, not in layout](images/RS2-51-wall.png)
...
XSLOPE brackets a factor well below both published ones, one trial of that bracket reaches the
sweep budget without a verdict so the row is reported rather than locked, and the two codes are not
measuring the same mechanism. Leshchinsky & Han's referee fails on a
...
are all the 24 m section, and the strength reduction runs on that one. A bearing mechanism is
sensitive to the run of ground in front of the toe, so the two sections are kept as separate files
...
whole-mesh alternative. It brackets the highest factor in the family, two trials of that bracket reach the sweep budget
without a verdict on each of the two meshes, and a step of refinement moves the factor by six times
the bracket tolerance. It is the family's least settled row on both counts, and it is reported
without a lock.
...
The same 9 m of height in five 1.8 m tiers offset 0.6 m, three sheets per tier. It brackets a
factor and holds it under a refinement step — the five shorter tiers put more sheets across the
failing band than the three tall ones do.

| XSLOPE SSRM | L&H FDM referee | RS2 SSR |
|---|---|---|
| **1.018** | 1.00 (+1.8%) | 1.04 |

<!-- test: file=files/rocscience/vp094_fem.xlsx, type=fem_ssrm, expected_fs=1.018, element_type=tri6, target_size=1.0, tolerance=0.02, f_min=0.5, f_max=3.0, max_iter=250000, ssr_exclude=Blocks, tension_srf=false, k0=1, benchmark=RS2-55 -->
...
| 2 | deep toe-to-crest (Fig. 4) | *blocked* | **1.383** (locked) | — | 1.385 | 1.375 | 1.36 (+1.7%) | RS2 SSR |
...
zone reproduces Case 2: **SSRM 1.383 vs RS2 SSRM 1.36 (+1.7%)**, inside the corpus's usual
SSRM-vs-published band (cf. [RS2-63](#rs2-63) +0.8%), locked at the 1.0 m tri6 mesh. Case 4's
...
| III (12 m) | **0.769** | 0.81 (−5.1%) | 0.82 (−6.2%) | 1.03 (−25.3%) | locked |
...
predicts, and the bisection returns **0.769** — 5.1% conservative of RS2 and 6.2% of Plaxis. The
...
the caveat on the −5.1% rather than an explanation of it.
...
| C11 | Slope 3 LT Original | **1.413** | 1.46 (−3.2%) | 1.51 | 1.51 | RS2 SSRM (−3.2%) | *locked* |
...
−3.2 to −3.6% from RS2's SSRM, the positive offset matching the usual SSRM-vs-published gap
(cf. [RS2-63](#rs2-63), +0.8%). They are locked at the 1.0 m tri6 mesh.
...
**1.344 / 1.356 / 1.294** at 8 / 5 / 3 m and then returns to the 1.306 locked at 2.2 m, so the
...
<!-- test: file=files/rocscience/rs2_65.xlsx, type=fem_ssrm, expected_fs=1.356, element_type=tri6, target_size=5.0, tolerance=0.02, f_min=1.1, f_max=1.5, max_iter=16000, tension_srf=true, k0=1, benchmark=RS2-65-m5 -->
...
The skin is the shallower of the two and it is what an unfiltered SSRM reports: across the family
the filter-off value is **1.031** at three of the five thicknesses, −1.8% on the closed-form 1.050,
and **1.044** at the thinnest and the thickest band — nearly one number rather than a trend in h₁,
exactly as a depth-independent mechanism should behave. Setting `min_slip_depth` = 4 m — below the
fill skin, above the basal band — excludes the skin and returns the deep mechanism, which is far
stronger than the skin under the two thinnest bands and comes down toward the skin across the
three thicker ones: 1.094 against the skin's 1.031 at 6 m (+6.1%), and equal to it at 10 m.
Both are locked:
...
<!-- test: file=files/rocscience/rs2_66e.xlsx, type=fem_ssrm, expected_fs=1.044, element_type=tri6, target_size=3.0, tolerance=0.02, f_min=0.8, f_max=1.6, max_iter=16000, tension_srf=true, k0=1, benchmark=RS2-66e -->
...
<!-- test: file=files/rocscience/rs2_66d.xlsx, type=fem_ssrm, expected_fs=1.069, element_type=tri6, target_size=3.0, tolerance=0.02, f_min=0.8, f_max=1.6, max_iter=16000, tension_srf=true, min_slip_depth=4, k0=1, benchmark=RS2-66d-deep -->
<!-- test: file=files/rocscience/rs2_66e.xlsx, type=fem_ssrm, expected_fs=1.044, element_type=tri6, target_size=3.0, tolerance=0.02, f_min=0.8, f_max=1.6, max_iter=16000, tension_srf=true, min_slip_depth=4, k0=1, benchmark=RS2-66e-deep -->
...
to the skin's own level and the contours fill it. The third is the filtered run on the same
...
| Case 3 — 90 h, upstream | **2.023** | 2.04 (−0.8%) | 1.99 / 1.89 / 2.07 / 2.06 | 2.03 | — | **built** |
...
All six stages land within 1% of RS2's own SSR column.
...
<!-- test: file=files/rocscience/rs2_67d.xlsx, type=fem_ssrm, expected_fs=2.023, tolerance=0.02, f_min=1.0, f_max=3.0, max_iter=16000, ssr_zone=-6.95691;-29.8799;102.318;-29.8799;102.318;66.9821;-6.95691;66.9821, tension_srf=true, k0=1, benchmark=RS2-67d -->
...
The value is **mesh-converged**: 1.681 / 1.656 / 1.656 / 1.644 at 3 / 1.5 / 1.0 / 0.7 m target
sizes, holding inside one bracket width from 1.5 m down — at 3 m the zone is about one element
thick and the cutoff barely engages. Locked at the 1.0 m mesh.

<!-- test: file=files/rocscience/vp002.xlsx, type=fem_ssrm, expected_fs=1.681, element_type=tri6, target_size=3.0, tolerance=0.02, f_min=1.2, f_max=2.0, max_iter=16000, tension_srf=true, k0=1, benchmark=RS2-P4-VP2-m3.0 -->
<!-- test: file=files/rocscience/vp002.xlsx, type=fem_ssrm, expected_fs=1.656, element_type=tri6, target_size=1.5, tolerance=0.02, f_min=1.2, f_max=2.0, max_iter=16000, tension_srf=true, k0=1, benchmark=RS2-P4-VP2-m1.5 -->
...
<!-- test: file=files/rocscience/vp002.xlsx, type=fem_ssrm, expected_fs=1.656, element_type=tri6, target_size=1.0, tolerance=0.02, f_min=1.2, f_max=2.0, max_iter=16000, tension_srf=true, k0=1, benchmark=RS2-P4-VP2 -->
...
Carried verbatim onto the tag as an `ssr_zone`, it moves XSLOPE from 1.016 to **1.222** and moves
...
**Mesh.** The unconstrained branch holds at 1.016 under refinement, at the tagged 2.0 ft mesh
(1 499 tri6) and again at a 1.2 ft mesh (4 132 tri6), and the constrained branch does not
...
<!-- test: file=files/rocscience/vp068.xlsx, type=fem_ssrm, expected_fs=1.016, element_type=tri6, target_size=1.2, tolerance=0.02, f_min=0.8, f_max=1.4, max_iter=16000, tension_srf=true, k0=1, benchmark=RS2-P4-VP68-m1.2 -->
...
<!-- test: file=files/rocscience/vp102a.xlsx, type=fem_ssrm, expected_fs=2.470, element_type=tri6, target_size=2.5, tolerance=0.02, f_min=1.9, f_max=2.8, max_iter=16000, tension_srf=true, k0=1, benchmark=RS2-P4-VP102 -->
...
early on. The dry case, which has no water in it at all, sits +1.6% instead.*

*Case 3 adds the φ<sup>b</sup> = 37° suction credit, and it grows with the drainage: +1.5% at 300 h
...
<!-- test: file=files/rocscience/vp102t_300.xlsx, type=fem_ssrm, expected_fs=2.173, element_type=tri6, target_size=2.5, tolerance=0.02, f_min=1.5, f_max=2.9, max_iter=16000, suction_phi_b=Material 1:37, tension_srf=true, k0=1, benchmark=RS2-P4-VP102-t-300-c3 -->
