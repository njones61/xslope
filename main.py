...
from solve import oms, bishop, spencer, spencer_from_slides, janbu_simple, janbu_corrected, morgenstern_price
...
# Options: 'oms', 'bishop', 'spencer', spencer_from_slides, 'janbu_simple', 'janbu_corrected', 'morgenstern_price (janbu)', 'morgenstern_price (half-sine)'
method = 'spencer_from_slides'  # Change this to the desired method
...
elif method == 'spencer_from_slides':
    FS, beta_deg = spencer_from_slides(df)
