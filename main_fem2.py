...
from fem import build_fem_data, solve_fem, solve_ssrm, solve_fem_elastic_plastic, solve_ssrm_bisection
...
solution_new = solve_fem_elastic_plastic(fem_data, F=1.28, debug_level=2)
...
try:
    solution_old = solve_fem(fem_data, F=1.28, debug_level=1, plastic_stiffness_reduction=0.01)
...
solution_ssrm_new = solve_ssrm_bisection(fem_data, F_min=1.0, F_max=5.0, tolerance=0.01, debug_level=1)
