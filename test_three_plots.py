...
print("=== Testing All Three Plot Types ===")
print("This should have compact colorbars and aligned axes")

# Test all three plot types with improved layout
plot_fem_results(fem_data, solution, plot_type='stress,displacement,deformation', figsize=(14, 10))